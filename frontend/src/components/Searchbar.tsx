...
const Searchbar = (props: SearchbarProps) => {
    ...
    return(
        <div className="flex items-center gap-1 px-3 py-2 rounded-3xl border border-neutral-400 
            placeholder-gray-500 placeholder-opacity-100 transition-colors 
            duration-200 focus:outline-none focus:shadow-[0_2px_4px_0_rgba(0,0,0,0.25)] max-w-3xs">
                <input type={"search"}
                name={"search"} 
